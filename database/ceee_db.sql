...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2022 at 10:28 PM
...
CREATE TABLE `admin_acc` (
  ...
  `admin_pass` varchar(1000) CHARACTER SET utf8mb4 NOT NULL
...
CREATE TABLE `course_tbl` (
  ...
  `cou_name` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
...
(67, 'INFORMATION SYSTEMS', '2022-06-04 17:56:08');
...
CREATE TABLE `examinee_tbl` (
  ...
  `exmne_fullname` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_course` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_gender` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_birthdate` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_year_level` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_email` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_password` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exmne_status` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'active'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(9, 'ahmed mohamed', '65', 'male', '2000-06-03', 'second year', 'ismail213moh@gmail.com', '12345', 'active');
...
CREATE TABLE `exam_answers` (
  ...
  `exans_status` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'new',
...
(321, 9, 24, 31, 'hoohho', 'new', '2022-06-04 17:27:54');
...
CREATE TABLE `exam_attempt` (
  ...
  `exmne_id` int(11) NOT NULL,
  `exam_id` int(11) NOT NULL,
  `examat_status` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'used'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `exam_question_tbl` (
  ...
  `exam_id` int(11) NOT NULL,
  `exam_question` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_ch1` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_ch2` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_ch3` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_ch4` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_answer` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `exam_status` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'active'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(31, 24, 'hoooooooooooooo', 'hoohho', 'hho', 'hoohho', 'gigiig', 'A', 'active');
...
CREATE TABLE `exam_tbl` (
  ...
  `ex_time_limit` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
...
(26, 67, 'management', '30', 30, 'بيبيلابيلابللابللابل لا', '2022-12-12 21:27:48'),
(27, 65, 'تنبيتنبي', '30', 556455, 'تنبيتنبتني\r\n', '2022-12-12 21:24:39');
...
CREATE TABLE `feedbacks_tbl` (
  ...
  `exmne_id` int(11) NOT NULL,
  `fb_exmne_as` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `fb_feedbacks` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `fb_date` varchar(1000) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
